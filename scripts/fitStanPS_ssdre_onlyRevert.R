...
pred.dat.ps.onlyRevert = pred.dat.ps
rm(pred.dat.ps)

save(list = c('pred.dat.ps.onlyRevert'), file = '../data/mostRecentPredDat_PS_onlyRevert.rdata')

save.image(paste0('../large_data/stanoutput_ps_onlyRevert',date(),'.rdata'))

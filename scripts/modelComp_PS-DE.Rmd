...
log.lik.ps = extract_log_lik(fit.ps, parameter_name = "y_hat", merge_chains = TRUE)
waic.ps = waic(log.lik.ps)
waic.loo.ps = loo(log.lik.ps)
rm(fit.ps)
load('../large_data/stanoutput_ps_noRevertMon Jul  2 22:18:12 2018.rdata')
log.lik.ps.nr = extract_log_lik(fit.ps, parameter_name = "y_hat", merge_chains = TRUE)
waic.ps.nr = waic(log.lik.ps.nr)
waic.loo.ps.nr = loo(log.lik.ps.nr)

rm(fit.ps)
load('../large_data/stanoutput_de_noRevertWed Jul  4 16:11:32 2018.rdata')
log.lik.de.nr = extract_log_lik(fit.de, parameter_name = "y_hat", merge_chains = TRUE)
